...
-- 2. TABLA PACIENTES_PERFIL (Coma final corregida)
...
-- 3. TABLA ESPECIALISTAS_PERFIL (Solo la info necesaria)
...
-- 4. TABLA FAVORITOS (Permite guardar varios doctores)
...
-- DATOS DE PRUEBA: Las 3 Doctoras
...
-- DATOS DE PRUEBA: Sus perfiles clínicos
