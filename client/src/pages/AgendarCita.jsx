      ...
      <div className="px-4 py-6 space-y-6">
              ...
              {todosLosSlots.map((h) => {
                ...
                return (
                  <button
                    ...
                    className={`py-3 rounded-xl text-[11px] font-bold border-2 transition-all ${
                      isOccupied ? 'bg-gray-100 border-gray-100 text-gray-400' :
        ...
        <div className="flex gap-3 pt-4">
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-4 rounded-kuxtal font-bold text-sm transition-all ${
              fechaSeleccionada && horaSeleccionada && !isLoading
